...
-- Replaces ingested_records for legal document search
-- ============================================================
...
CREATE TABLE IF NOT EXISTS legal_documents (
    ...
    practice_area VARCHAR(100),              -- constitutional_law, employment, criminal, tort, contract, ip
    status VARCHAR(50) DEFAULT 'good_law',   -- good_law, distinguished, overruled, questioned

    -- Embeddings (768-dim, ModernBERT legal fine-tuned: freelawproject/modernbert-embed-base_finetune_512)
    ...
    -- Full-text search columns for hybrid search (BM25-equivalent)
...
-- GIN indexes for full-text search (enables hybrid search)
